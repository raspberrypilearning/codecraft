...
def maak(bron):
  ...
  #als de bron niet kan worden gemaakt...
  if bron in maken:
...
def tekenBron(y, x):
  #Deze variabele stopt andere dingen die getekend worden
  global tekenen
...
#teken de spelers op de wereld
def tekenSpeler():
  spelerT.goto( (spelerX * TEGELGROOTTE) + 20, hoogte - (spelerY * TEGELGROOTTE) -20 )
...
#maak een nieuw spelerobject
spelerT = turtle.Turtle()
spelerT.hideturtle()
spelerT.shape(spelerImg)
spelerT.penup()
spelerT.speed(0)
