...
**इस परियोजना में Python 3 का उपयोग किया जाता है।**Python को ऑनलाइन लिखने के लिए हम [trinket](https://trinket.io/) का उपयोग करने की सलाह देते हैं। इस परियोजना में निम्नलिखित Trinket हैं:

+ ['कोडक्राफ्ट' प्रारंभक परियोजना - rpf.io/codecraft-on](http://rpf.io/codecraft-on)

एक ऐसा trinket भी है जिसमें पूर्ण परियोजना है:
...
+ "अपना विश्व आकार बदलें" - ` MAPWIDTH` और ` MAPHEIGHT `वेरिएबल का संपादन करना दुनिया के आकार को बदलने के लिए;
...
+ [ऑनलाइन Trinket जिसमें सभी 'CodeCraft' परियोजना संसाधन हैं](http://rpf.io/codecraft-on)
